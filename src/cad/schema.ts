...
const ASSEMBLY_TOOLS: CatalogEntry[] = [
  ...
  assemblyEntry("set_parallel", "Make two planar normals or axes parallel. Pure orientation: the second referenced instance rotates minimally about its reference point; position is not translated.", { assembly_id: { type: "string" }, a_instance: { type: "string" }, a_ref: assemblyRefFace, b_instance: { type: "string" }, b_ref: assemblyRefFace }, ["assembly_id","a_instance","a_face","b_instance","b_face"]),
  assemblyEntry("set_perpendicular", "Make two planar normals or axes perpendicular (minimal deterministic rotation of the second referenced instance).", { assembly_id: { type: "string" }, a_instance: { type: "string" }, a_ref: assemblyRefFace, b_instance: { type: "string" }, b_ref: assemblyRefFace }, ["assembly_id","a_instance","a_face","b_instance","b_face"]),
  entry({
